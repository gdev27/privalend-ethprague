...
const rawEnv = {
  ...
  intentRegistryAddress: process.env.NEXT_PUBLIC_INTENT_REGISTRY_ADDRESS,
  kmsAddress: process.env.NEXT_PUBLIC_KMS_ADDRESS,
  liquidationLtvPercent: process.env.NEXT_PUBLIC_LIQUIDATION_LTV_PERCENT,
  loanCoreAddress: process.env.NEXT_PUBLIC_LOAN_CORE_ADDRESS,
  matchingCoordinatorAddress: process.env.NEXT_PUBLIC_MATCHING_COORDINATOR_ADDRESS,
...
const defaults = {
  ...
  collateralTokenAddress: "0x70B0FE94eE8665CF63Bf466cCC0Ed9bcCeBaa1F3",
  debtTokenAddress: "0x1ba22D78fB5d9910E77612032fE5d2dDF1A8A8F1",
  intentRegistryAddress: "0x1bDb5993C3D1F089DaEab4351e1C0c92685301D7",
  kmsAddress: "0xbD7C5746F9E7783cd4AcDEeE700D195FEB9eE730",
  liquidationLtvPercent: "90",
  loanCoreAddress: "0xC82A109460078976EFE0CB775cAF213C3787f8f3",
  matchingCoordinatorAddress: "0xcCDA03ec6BA2768Fc50b1fF0AD18462Beb9f6586",
  networkName: "Sepolia",
  poolAddress: "0xC82A109460078976EFE0CB775cAF213C3787f8f3",
  positionManagerAddress: "0x1Ac826fb43e430a6c7BFAD461a0fa8a752f483Fd",
...
export const publicEnv = {
  ...
  intentRegistryAddress: publicAddress(rawEnv.intentRegistryAddress, defaults.intentRegistryAddress, "NEXT_PUBLIC_INTENT_REGISTRY_ADDRESS"),
  ...
  loanCoreAddress: publicAddress(rawEnv.loanCoreAddress, defaults.loanCoreAddress, "NEXT_PUBLIC_LOAN_CORE_ADDRESS"),
  matchingCoordinatorAddress: publicAddress(rawEnv.matchingCoordinatorAddress, defaults.matchingCoordinatorAddress, "NEXT_PUBLIC_MATCHING_COORDINATOR_ADDRESS"),
  ...
  positionManagerAddress: publicAddress(rawEnv.positionManagerAddress, defaults.positionManagerAddress, "NEXT_PUBLIC_POSITION_MANAGER_ADDRESS"),
